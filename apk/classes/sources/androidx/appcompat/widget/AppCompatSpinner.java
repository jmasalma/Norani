...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        ...
        L_0x0035:
            ...
            int[] r12 = ATTRS_ANDROID_SPINNERMODE     // Catch:{ Exception -> 0x0057, all -> 0x0055 }
            android.content.res.TypedArray r12 = r8.obtainStyledAttributes(r9, r12, r10, r1)     // Catch:{ Exception -> 0x0057, all -> 0x0055 }
            boolean r4 = r12.hasValue(r1)     // Catch:{ Exception -> 0x0053 }
            if (r4 == 0) goto L_0x004d
            int r11 = r12.getInt(r1, r1)     // Catch:{ Exception -> 0x0053 }
        L_0x004d:
        ...
        L_0x0059:
            ...
            android.util.Log.i(r5, r6, r4)     // Catch:{ all -> 0x0063 }
            if (r12 == 0) goto L_0x006b
            goto L_0x004f
        L_0x0063:
            r8 = move-exception
