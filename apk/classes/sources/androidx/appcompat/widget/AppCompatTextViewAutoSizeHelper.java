...
class AppCompatTextViewAutoSizeHelper {
    ...
    private boolean suggestedSizeFitsInSpace(int i, RectF rectF) {
        ...
        StaticLayout createStaticLayoutForMeasuring = createStaticLayoutForMeasuring(text, (Layout.Alignment) invokeAndReturnWithDefault(this.mTextView, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:6:0x0011, code lost:
        android.util.Log.w(TAG, "Failed to invoke TextView#" + r5 + "() method", r4);
     */
    ...
    private <T> T invokeAndReturnWithDefault(java.lang.Object r4, java.lang.String r5, T r6) {
        /*
            r3 = this;
            java.lang.String r0 = "Failed to invoke TextView#"
            java.lang.reflect.Method r1 = r3.getTextViewMethod(r5)     // Catch:{ Exception -> 0x0010, all -> 0x000e }
            r2 = 0
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ Exception -> 0x0010, all -> 0x000e }
            java.lang.Object r6 = r1.invoke(r4, r2)     // Catch:{ Exception -> 0x0010, all -> 0x000e }
            goto L_0x0029
        L_0x000e:
            r4 = move-exception
            throw r4
