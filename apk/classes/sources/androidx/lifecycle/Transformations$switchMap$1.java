...
public final class Transformations$switchMap$1 implements Observer<X> {
    ...
    public void onChanged(X x) {
        LiveData<Y> liveData2 = (LiveData) this.$transform.invoke(x);
        ...
        if (liveData3 != liveData2) {
            ...
            if (liveData2 != null) {
                ...
                mediatorLiveData2.addSource(liveData2, new Transformations$sam$androidx_lifecycle_Observer$0(new Transformations$switchMap$1$onChanged$1(this.$result)));
            }
        }
    }
}
