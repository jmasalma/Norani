...
public class TopicsManagerImplCommon extends TopicsManager {
    ...
    public final Object getTopicsAsyncInternal(GetTopicsRequest getTopicsRequest, Continuation<? super GetTopicsResponse> continuation) {
        ...
        this.mTopicsManager.getTopics(getTopicsRequest, new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda0(), OutcomeReceiverKt.asOutcomeReceiver((CancellableContinuation) cancellableContinuationImpl));
