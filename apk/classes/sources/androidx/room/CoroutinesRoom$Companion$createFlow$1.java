...
final class CoroutinesRoom$Companion$createFlow$1 extends SuspendLambda implements Function2<FlowCollector<R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return (Continuation) coroutinesRoom$Companion$createFlow$1;
    }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> r0 = new AnonymousClass1(z, roomDatabase, flowCollector, strArr, callable, continuation);
            r0.L$0 = obj;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Channel$default.m106trySendJP2dKIU(Unit.INSTANCE);
                ...
                if (transactionElement == null || (continuationInterceptor = transactionElement.getTransactionDispatcher$room_ktx_release()) == null) {
                    continuationInterceptor = (ContinuationInterceptor) (z ? CoroutinesRoomKt.getTransactionDispatcher(roomDatabase) : CoroutinesRoomKt.getQueryDispatcher(roomDatabase));
                }
                ...
                BuildersKt.launch$default(coroutineScope, (CoroutineContext) continuationInterceptor, (CoroutineStart) null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>((Continuation<? super AnonymousClass1>) null) {
                    Object L$0;
                    int label;
                    ...
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ...
                                this.label = 1;
                                if (CoroutineScopeKt.coroutineScope(new AnonymousClass1((Continuation<? super AnonymousClass1>) null), (Continuation) this) == coroutine_suspended) {
