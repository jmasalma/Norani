...
public final class CoroutinesRoom {
    ...
    public static final class Companion {
        ...
        public final <R> Object execute(RoomDatabase roomDatabase, boolean z, Callable<R> callable, Continuation<? super R> continuation) {
            ...
            TransactionElement transactionElement = continuation.getContext().get(TransactionElement.Key);
            ...
            return BuildersKt.withContext((CoroutineContext) continuationInterceptor, new CoroutinesRoom$Companion$execute$2(callable, (Continuation<? super CoroutinesRoom$Companion$execute$2>) null), continuation);
        }
        ...
        public final <R> Object execute(RoomDatabase roomDatabase, boolean z, CancellationSignal cancellationSignal, Callable<R> callable, Continuation<? super R> continuation) {
            ...
            if (transactionElement == null || (continuationInterceptor = transactionElement.getTransactionDispatcher$room_ktx_release()) == null) {
                if (z) {
                    continuationInterceptor2 = CoroutinesRoomKt.getTransactionDispatcher(roomDatabase);
                } else {
                    continuationInterceptor2 = CoroutinesRoomKt.getQueryDispatcher(roomDatabase);
                }
                continuationInterceptor = continuationInterceptor2;
            }
            ...
            cancellableContinuation.invokeOnCancellation(new CoroutinesRoom$Companion$execute$4$1(cancellationSignal, BuildersKt.launch$default(GlobalScope.INSTANCE, (CoroutineContext) continuationInterceptor, (CoroutineStart) null, new CoroutinesRoom$Companion$execute$4$job$1(callable, cancellableContinuation, (Continuation<? super CoroutinesRoom$Companion$execute$4$job$1>) null), 2, (Object) null)));
