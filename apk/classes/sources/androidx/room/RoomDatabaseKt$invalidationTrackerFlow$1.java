...
final class RoomDatabaseKt$invalidationTrackerFlow$1 extends SuspendLambda implements Function2<ProducerScope<? super Set<? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> roomDatabaseKt$invalidationTrackerFlow$1 = new RoomDatabaseKt$invalidationTrackerFlow$1(this.$emitInitialState, this.$this_invalidationTrackerFlow, this.$tables, continuation);
        roomDatabaseKt$invalidationTrackerFlow$1.L$0 = obj;
        return (Continuation) roomDatabaseKt$invalidationTrackerFlow$1;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            RoomDatabaseKt$invalidationTrackerFlow$1$observer$1 roomDatabaseKt$invalidationTrackerFlow$1$observer$1 = new RoomDatabaseKt$invalidationTrackerFlow$1$observer$1(this.$tables, atomicBoolean, coroutineScope);
            TransactionElement transactionElement = coroutineScope.getCoroutineContext().get(TransactionElement.Key);
            ...
            CoroutineContext coroutineContext = (CoroutineContext) continuationInterceptor;
            final Job launch$default = BuildersKt.launch$default(coroutineScope2, coroutineContext, (CoroutineStart) null, new RoomDatabaseKt$invalidationTrackerFlow$1$job$1(this.$this_invalidationTrackerFlow, roomDatabaseKt$invalidationTrackerFlow$1$observer$1, this.$emitInitialState, coroutineScope, this.$tables, atomicBoolean, (Continuation<? super RoomDatabaseKt$invalidationTrackerFlow$1$job$1>) null), 2, (Object) null);
            this.label = 1;
