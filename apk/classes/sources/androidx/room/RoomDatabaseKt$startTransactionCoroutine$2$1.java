...
final class RoomDatabaseKt$startTransactionCoroutine$2$1 implements Runnable {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> r0 = new AnonymousClass1(roomDatabase, cancellableContinuation, function2, continuation);
            r0.L$0 = obj;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                CoroutineContext access$createTransactionContext = RoomDatabaseKt.createTransactionContext(roomDatabase, continuationInterceptor);
                Continuation continuation2 = (Continuation) cancellableContinuation;
                Result.Companion companion = Result.Companion;
                this.L$0 = continuation2;
                this.label = 1;
                obj = BuildersKt.withContext(access$createTransactionContext, function2, (Continuation) this);
