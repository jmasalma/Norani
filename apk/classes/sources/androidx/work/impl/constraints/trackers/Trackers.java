...
public final class Trackers {
    ...
    public Trackers(Context context2, TaskExecutor taskExecutor) {
        this(context2, taskExecutor, (ConstraintTracker) null, (BatteryNotLowTracker) null, (ConstraintTracker) null, (ConstraintTracker) null, 60, (DefaultConstructorMarker) null);
    ...
    public Trackers(Context context2, TaskExecutor taskExecutor, ConstraintTracker<Boolean> constraintTracker) {
        this(context2, taskExecutor, constraintTracker, (BatteryNotLowTracker) null, (ConstraintTracker) null, (ConstraintTracker) null, 56, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context2, "context");
        Intrinsics.checkNotNullParameter(taskExecutor, "taskExecutor");
    ...
    public Trackers(Context context2, TaskExecutor taskExecutor, ConstraintTracker<Boolean> constraintTracker, BatteryNotLowTracker batteryNotLowTracker2) {
        this(context2, taskExecutor, constraintTracker, batteryNotLowTracker2, (ConstraintTracker) null, (ConstraintTracker) null, 48, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context2, "context");
        Intrinsics.checkNotNullParameter(taskExecutor, "taskExecutor");
        Intrinsics.checkNotNullParameter(constraintTracker, "batteryChargingTracker");
    ...
    public Trackers(Context context2, TaskExecutor taskExecutor, ConstraintTracker<Boolean> constraintTracker, BatteryNotLowTracker batteryNotLowTracker2, ConstraintTracker<NetworkState> constraintTracker2) {
        this(context2, taskExecutor, constraintTracker, batteryNotLowTracker2, constraintTracker2, (ConstraintTracker) null, 32, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context2, "context");
        Intrinsics.checkNotNullParameter(taskExecutor, "taskExecutor");
        Intrinsics.checkNotNullParameter(constraintTracker, "batteryChargingTracker");
        Intrinsics.checkNotNullParameter(batteryNotLowTracker2, "batteryNotLowTracker");
