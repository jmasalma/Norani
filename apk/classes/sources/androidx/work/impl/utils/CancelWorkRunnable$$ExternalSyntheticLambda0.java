...
public final /* synthetic */ class CancelWorkRunnable$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ CancelWorkRunnable$$ExternalSyntheticLambda0(WorkDatabase workDatabase, String str, WorkManagerImpl workManagerImpl) {
    ...
    public final void run() {
        CancelWorkRunnable.forNameInline$lambda$0(this.f$0, this.f$1, this.f$2);
    }
}
