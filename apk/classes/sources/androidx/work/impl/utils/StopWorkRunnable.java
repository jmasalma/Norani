...
public final class StopWorkRunnable implements Runnable {
    ...
    public StopWorkRunnable(Processor processor2, StartStopToken startStopToken, boolean z, int i) {
    ...
    public StopWorkRunnable(Processor processor2, StartStopToken startStopToken, boolean z) {
    ...
    public void run() {
        ...
        Logger.get().debug(Logger.tagWithPrefix("StopWorkRunnable"), "StopWorkRunnable for " + this.token.getId().getWorkSpecId() + "; Processor.stopWork = " + z);
    }
}
