...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
    ...
    public final boolean cancel(boolean z) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractFuture, obj, cancellation)) {
                ...
                AbstractFuture abstractFuture2 = ((SetFuture) obj).future;
                if (abstractFuture2 instanceof AbstractFuture) {
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [androidx.work.impl.utils.futures.AbstractFuture, java.util.concurrent.Future] */
