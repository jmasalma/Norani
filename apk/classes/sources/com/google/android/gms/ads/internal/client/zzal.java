...
final class zzal extends zzba {
    ...
    zzal(zzaz zzaz, Context context, zzr zzr, String str, zzbpq zzbpq) {
        this.zza = context;
        this.zzb = zzr;
        this.zzc = str;
        this.zzd = zzbpq;
    ...
    public final /* bridge */ /* synthetic */ Object zzb(zzcr zzcr) throws RemoteException {
        return zzcr.zzd(ObjectWrapper.wrap(this.zza), this.zzb, this.zzc, this.zzd, ModuleDescriptor.MODULE_VERSION);
    }
