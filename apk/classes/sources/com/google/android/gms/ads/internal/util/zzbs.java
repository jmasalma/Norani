...
public final class zzbs {
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (obj == null) {
                            ...
                            int i3 = zze.zza;
                            zzo.zzj("Expected JSONArray with at least 1 non-null element for key:".concat(valueOf));
                            ...
                            String format = String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next});
                            int i4 = zze.zza;
                            zzo.zzj(format);
                        }
                    }
                    ...
                    int i5 = zze.zza;
                    zzo.zzj("Unsupported type for key:".concat(valueOf2));
                }
            }
        }
        return bundle;
    ...
    public static String zzm(zzfcf zzfcf) {
        if (zzfcf == null) {
            return null;
        }
