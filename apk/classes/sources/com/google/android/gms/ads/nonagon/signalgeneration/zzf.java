...
public final class zzf {
    ...
    zzf(Context context, zzbcn zzbcn, List list, VersionInfoParcel versionInfoParcel) {
        this.zza = context;
    ...
    public final void zzb(WebView webView) {
        if (!this.zzf.getAndSet(true)) {
            ...
            for (String str : ((String) zzbd.zzc().zzb(zzbde.zzkk)).split(",", -1)) {
            ...
            if (((Boolean) zzbfj.zzb.zze()).booleanValue() && WebViewFeature.isFeatureSupported(WebViewFeature.DOCUMENT_START_SCRIPT) && webView != null) {
                WebViewCompat.addDocumentStartJavaScript(webView, String.format(Locale.getDefault(), (String) zzbd.zzc().zzb(zzbde.zzkj), new Object[]{zza()}), zzfyv.zzo(ProxyConfig.MATCH_ALL_SCHEMES));
            }
        }
    }
}
