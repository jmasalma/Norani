...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.m74trySendJP2dKIU(getValue());
                }
    ...
    public Object m67trySendJP2dKIU(E e) {
        Lock lock2 = this.lock;
        lock2.lock();
        try {
            if (isClosedForSend()) {
                return super.m74trySendJP2dKIU(e);
            }
            ...
            if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
                for (BufferedChannel shouldSendSuspend$kotlinx_coroutines_core : iterable) {
                    if (shouldSendSuspend$kotlinx_coroutines_core.shouldSendSuspend$kotlinx_coroutines_core()) {
                        Object r4 = ChannelResult.Companion.m96failurePtdJZtk();
                        lock2.unlock();
                        return r4;
                    }
                }
            ...
            for (BufferedChannel r2 : this.subscribers) {
                r2.m74trySendJP2dKIU(e);
            }
            Object r42 = ChannelResult.Companion.m97successJP2dKIU(Unit.INSTANCE);
            lock2.unlock();
            return r42;
        } finally {
            lock2.unlock();
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object obj) {
        ...
        try {
            ...
            lock2.unlock();
            BuildersKt.launch$default(CoroutineScopeKt.CoroutineScope(selectInstance.getContext()), (CoroutineContext) null, CoroutineStart.UNDISPATCHED, new BroadcastChannelImpl$registerSelectForSend$2(this, obj, selectInstance, (Continuation<? super BroadcastChannelImpl$registerSelectForSend$2>) null), 1, (Object) null);
        } finally {
            lock2.unlock();
        }
    }
