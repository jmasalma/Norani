...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object m75receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object r2 = this._channel.m104receiveCatchingJP2dKIU(continuation);
    ...
    public Object m76tryReceivePtdJZtk() {
        return this._channel.m105tryReceivePtdJZtk();
    }

    /* renamed from: trySend-JP2dKIU  reason: not valid java name */
    public Object m77trySendJP2dKIU(E e) {
        return this._channel.m106trySendJP2dKIU(e);
    }
    ...
    public final void cancel(CancellationException cancellationException) {
        if (!isCancelled()) {
            if (cancellationException == null) {
                ...
                cancellationException = (CancellationException) new JobCancellationException(JobSupport.access$cancellationExceptionMessage(job), (Throwable) null, job);
            }
