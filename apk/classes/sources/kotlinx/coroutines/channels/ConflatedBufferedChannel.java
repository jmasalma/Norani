...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object r4 = conflatedBufferedChannel.m101trySendImplMj0NB7M(e, true);
        if (!(r4 instanceof ChannelResult.Closed)) {
            return Unit.INSTANCE;
        }
        ChannelResult.m86exceptionOrNullimpl(r4);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object r0 = conflatedBufferedChannel.m101trySendImplMj0NB7M(e, true);
    ...
    public Object m102trySendJP2dKIU(E e) {
        return m101trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m101trySendImplMj0NB7M(E e, boolean z) {
        if (this.onBufferOverflow == BufferOverflow.DROP_LATEST) {
            return m99trySendDropLatestMj0NB7M(e, z);
        }
        return m100trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m99trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1 function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object r0 = super.m74trySendJP2dKIU(e);
        if (ChannelResult.m92isSuccessimpl(r0) || ChannelResult.m90isClosedimpl(r0)) {
            return r0;
        }
        if (!z || (function1 = this.onUndeliveredElement) == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, (UndeliveredElementException) null, 2, (Object) null)) == null) {
            return ChannelResult.Companion.m97successJP2dKIU(Unit.INSTANCE);
        }
        throw callUndeliveredElementCatchingException$default;
    }

    /* renamed from: trySendDropOldest-JP2dKIU  reason: not valid java name */
    private final Object m100trySendDropOldestJP2dKIU(E e) {
        ChannelSegment channelSegment;
        Waiter waiter = BufferedChannelKt.BUFFERED;
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (access$findSegmentSend != null) {
                    ...
                    return ChannelResult.Companion.m95closedJP2dKIU(getSendException());
                }
            } else {
                channelSegment = channelSegment2;
            }
            int access$updateCellSend = bufferedChannel.updateCellSend(channelSegment, i, e, j, waiter, access$isClosedForSend0);
            if (access$updateCellSend == 0) {
                ...
                if (access$updateCellSend != 2) {
                    ...
                    if (waiter2 != null) {
                        bufferedChannel.prepareSenderForSuspension(waiter2, channelSegment, i);
                    }
