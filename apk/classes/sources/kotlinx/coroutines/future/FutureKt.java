...
public final class FutureKt {
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) {
        ...
        if (completableFuture.isDone()) {
            ...
            ContinuationHandler continuationHandler = new ContinuationHandler(continuation2);
            completionStage.handle(continuationHandler);
            continuation2.invokeOnCancellation(new FutureKt$await$2$1(completableFuture, continuationHandler));
