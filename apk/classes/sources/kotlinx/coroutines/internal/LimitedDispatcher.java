...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        this.queue.addLast(runnable);
        if (runningWorkers$FU.get(this) < this.parallelism && tryAllocateWorker() && (obtainTaskOrDeallocateWorker = obtainTaskOrDeallocateWorker()) != null) {
            this.dispatcher.dispatch((CoroutineContext) this, new Worker(obtainTaskOrDeallocateWorker));
        }
    }
    ...
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        this.queue.addLast(runnable);
        if (runningWorkers$FU.get(this) < this.parallelism && tryAllocateWorker() && (obtainTaskOrDeallocateWorker = obtainTaskOrDeallocateWorker()) != null) {
            this.dispatcher.dispatchYield((CoroutineContext) this, new Worker(obtainTaskOrDeallocateWorker));
        }
    }
}
