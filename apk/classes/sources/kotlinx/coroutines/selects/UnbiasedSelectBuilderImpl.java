...
public final class UnbiasedSelectBuilderImpl<R> extends UnbiasedSelectImplementation<R> {
    ...
    public final Object initSelectResult() {
        ...
        BuildersKt.launch$default(CoroutineScopeKt.CoroutineScope(getContext()), (CoroutineContext) null, CoroutineStart.UNDISPATCHED, new UnbiasedSelectBuilderImpl$initSelectResult$1(this, (Continuation<? super UnbiasedSelectBuilderImpl$initSelectResult$1>) null), 1, (Object) null);
        return this.cont.getResult();
    }

    public final void handleBuilderException(Throwable th) {
        Result.Companion companion = Result.Companion;
        this.cont.resumeWith(Result.constructor-impl(ResultKt.createFailure(th)));
    }
}
