...
public final class zzadl implements zzadw {
    ...
    public zzadl(zzl zzl, long j, long j2) {
        this.zzb = zzl;
        this.zzd = j;
        this.zzc = j2;
    }
    ...
    public final int zzc(int i) throws IOException {
        int zzr = zzr(1);
        if (zzr == 0) {
            zzr = zzq(this.zza, 0, Math.min(1, ConstantsKt.DEFAULT_BLOCK_SIZE), 0, true);
        }
        zzs(zzr);
        return zzr;
    }
    ...
    public final boolean zzo(int i, boolean z) throws IOException {
        int zzr = zzr(i);
        while (zzr < i && zzr != -1) {
            zzr = zzq(this.zza, -zzr, Math.min(i, zzr + ConstantsKt.DEFAULT_BLOCK_SIZE), zzr, z);
        }
        zzs(zzr);
        return zzr != -1;
    }
