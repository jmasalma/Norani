...
public final class zzadq implements zzaea {
    ...
    private static final zzadp zzc = new zzadp(new zzadm());
    private static final zzadp zzd = new zzadp(new zzadn());
    private zzfyq zze;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:113:0x01c1, code lost:
        switch(r3) {
            ...
            case com.google.android.gms.internal.ads.zzbcj.zzt.zzm :int: goto L_0x01db;
    ...
    public final synchronized com.google.android.gms.internal.ads.zzadv[] zza(android.net.Uri r25, java.util.Map r26) {
        /*
            ...
            r1 = r24
            monitor-enter(r24)
            java.util.ArrayList r0 = new java.util.ArrayList     // Catch:{ all -> 0x03e5 }
            r2 = 21
            r0.<init>(r2)     // Catch:{ all -> 0x03e5 }
            java.lang.String r3 = "Content-Type"
            r4 = r26
            java.lang.Object r3 = r4.get(r3)     // Catch:{ all -> 0x03e5 }
            java.util.List r3 = (java.util.List) r3     // Catch:{ all -> 0x03e5 }
            r4 = 0
            if (r3 == 0) goto L_0x0025
            boolean r5 = r3.isEmpty()     // Catch:{ all -> 0x03e5 }
            if (r5 == 0) goto L_0x001e
            goto L_0x0025
        L_0x001e:
            java.lang.Object r3 = r3.get(r4)     // Catch:{ all -> 0x03e5 }
            java.lang.String r3 = (java.lang.String) r3     // Catch:{ all -> 0x03e5 }
            goto L_0x0026
        L_0x0025:
            r3 = 0
        L_0x0026:
        ...
        L_0x0045:
            ...
            goto L_0x01f9
        L_0x0048:
            java.lang.String r3 = com.google.android.gms.internal.ads.zzay.zze(r3)     // Catch:{ all -> 0x03e5 }
            int r23 = r3.hashCode()     // Catch:{ all -> 0x03e5 }
            switch(r23) {
        ...
        L_0x0055:
            ...
            boolean r3 = r3.equals(r5)     // Catch:{ all -> 0x03e5 }
        ...
        L_0x01f9:
            ...
            r1.zzb(r3, r0)     // Catch:{ all -> 0x03e5 }
        L_0x01fe:
            java.lang.String r5 = r25.getLastPathSegment()     // Catch:{ all -> 0x03e5 }
        ...
        L_0x0207:
            ...
            boolean r6 = r5.endsWith(r6)     // Catch:{ all -> 0x03e5 }
        ...
        L_0x0258:
            ...
            goto L_0x03b9
        L_0x0272:
            int r6 = r5.length()     // Catch:{ all -> 0x03e5 }
            java.lang.String r8 = ".mk"
            int r6 = r6 + -4
            boolean r6 = r5.startsWith(r8, r6)     // Catch:{ all -> 0x03e5 }
        ...
        L_0x0295:
            ...
            boolean r6 = r5.startsWith(r7, r6)     // Catch:{ all -> 0x03e5 }
            if (r6 != 0) goto L_0x03b3
            int r6 = r5.length()     // Catch:{ all -> 0x03e5 }
        ...
        L_0x0396:
            ...
            boolean r5 = r5.endsWith(r6)     // Catch:{ all -> 0x03e5 }
        ...
        L_0x03bf:
            ...
            r1.zzb(r5, r0)     // Catch:{ all -> 0x03e5 }
        L_0x03c6:
            int[] r4 = zzb     // Catch:{ all -> 0x03e5 }
            r6 = 0
        L_0x03c9:
            if (r6 >= r2) goto L_0x03d7
            r7 = r4[r6]     // Catch:{ all -> 0x03e5 }
            if (r7 == r3) goto L_0x03d4
            if (r7 == r5) goto L_0x03d4
            r1.zzb(r7, r0)     // Catch:{ all -> 0x03e5 }
        L_0x03d4:
            int r6 = r6 + 1
            goto L_0x03c9
        L_0x03d7:
            int r2 = r0.size()     // Catch:{ all -> 0x03e5 }
            com.google.android.gms.internal.ads.zzadv[] r2 = new com.google.android.gms.internal.ads.zzadv[r2]     // Catch:{ all -> 0x03e5 }
            java.lang.Object[] r0 = r0.toArray(r2)     // Catch:{ all -> 0x03e5 }
            com.google.android.gms.internal.ads.zzadv[] r0 = (com.google.android.gms.internal.ads.zzadv[]) r0     // Catch:{ all -> 0x03e5 }
            monitor-exit(r24)
            return r0
        L_0x03e5:
            r0 = move-exception
            monitor-exit(r24)     // Catch:{ all -> 0x03e5 }
            throw r0
        */
    ...
    private final void zzb(int i, List list) {
        switch (i) {
            ...
            case 7:
                ...
                return;
            case 8:
                zzakr zzakr = this.zzf;
                list.add(new zzajd(zzakr, 0, (zzeu) null, (zzajp) null, zzfyq.zzn(), (zzafb) null));
                list.add(new zzajj(zzakr, 0));
                return;
            case 9:
                list.add(new zzajz());
                return;
            ...
            case 11:
                ...
                list.add(new zzaoj(1, 0, this.zzf, new zzeu(0), new zzamw(0, this.zze), 112800));
                return;
            case 12:
                list.add(new zzaov());
                return;
