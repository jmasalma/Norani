...
final class zzagd extends zzagf {
    ...
    private static Double zzg(zzen zzen) {
        return Double.valueOf(Double.longBitsToDouble(zzen.zzt()));
    }
    ...
    private static String zzi(zzen zzen) {
        ...
        int zzc2 = zzen.zzc();
        zzen.zzM(zzq);
        return new String(zzen.zzN(), zzc2, zzq);
    }
    ...
    /* access modifiers changed from: protected */
    public final boolean zzb(zzen zzen, long j) {
        if (zzen.zzm() == 2 && "onMetaData".equals(zzi(zzen)) && zzen.zza() != 0 && zzen.zzm() == 8) {
    ...
    private static java.lang.Object zzh(com.google.android.gms.internal.ads.zzen r4, int r5) {
        ...
        L_0x007a:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzagd.zzh(com.google.android.gms.internal.ads.zzen, int):java.lang.Object");
    }
}
