...
final class zzaia {
    ...
    public final long zzd(zzadw zzadw, boolean z, boolean z2, int i) throws IOException {
        if (this.zzc == 0) {
            byte[] bArr = this.zzb;
            if (!zzadw.zzn(bArr, 0, 1, z)) {
                return -1;
            }
            int zzb2 = zzb(bArr[0] & 255);
            this.zzd = zzb2;
            if (zzb2 != -1) {
                this.zzc = 1;
            } else {
