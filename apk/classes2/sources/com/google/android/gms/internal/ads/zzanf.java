...
final class zzanf {
    ...
    public zzanf(zzafb zzafb, boolean z, boolean z2) {
        this.zza = zzafb;
    ...
    public final void zza(zzft zzft) {
        this.zzc.append(zzft.zza, zzft);
    }

    public final void zzb(zzfu zzfu) {
        this.zzb.append(zzfu.zzd, zzfu);
    }
        ...
        if (this.zze == 9) {
            if (z && this.zzh) {
                ...
                if (j3 != -9223372036854775807L) {
                    long j4 = this.zzi;
                    if (j2 != j4) {
                        this.zza.zzt(j3, this.zzk ? 1 : 0, (int) (j2 - j4), i2, (zzafa) null);
                    }
                }
            }
            this.zzi = this.zzf;
