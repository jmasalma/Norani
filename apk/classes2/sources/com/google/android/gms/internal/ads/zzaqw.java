...
final class zzaqw {
    ...
    static zzaqw zza(zzaqx zzaqx) throws IOException {
        if (zzaqz.zze(zzaqx) == 538247942) {
            String zzh2 = zzaqz.zzh(zzaqx);
            String zzh3 = zzaqz.zzh(zzaqx);
            long zzf2 = zzaqz.zzf(zzaqx);
            long zzf3 = zzaqz.zzf(zzaqx);
            long zzf4 = zzaqz.zzf(zzaqx);
            long zzf5 = zzaqz.zzf(zzaqx);
            int zze2 = zzaqz.zze(zzaqx);
            if (zze2 >= 0) {
                List emptyList = zze2 == 0 ? Collections.emptyList() : new ArrayList();
                for (int i = 0; i < zze2; i++) {
                    emptyList.add(new zzapv(zzaqz.zzh(zzaqx).intern(), zzaqz.zzh(zzaqx).intern()));
                }
                return new zzaqw(zzh2, zzh3, zzf2, zzf3, zzf4, zzf5, emptyList);
            }
    ...
    zzaqw(java.lang.String r14, com.google.android.gms.internal.ads.zzapm r15) {
        /*
            r13 = this;
