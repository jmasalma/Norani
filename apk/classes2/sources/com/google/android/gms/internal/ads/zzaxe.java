...
public final class zzaxe implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzaxe(Context context, zzawq zzawq) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzaxd zzaxd = new zzaxd(this);
            this.zzf = zzaxd;
            this.zzb.registerReceiver(zzaxd, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0036:
            ...
            com.google.android.gms.internal.ads.zzawm r0 = r3.zzj     // Catch:{ Exception -> 0x003f }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x003f }
        L_0x003f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaxe.zzi(android.view.View):void");
    }
