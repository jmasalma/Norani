...
public final class zzbef {
    ...
    public final void zzb(Activity activity) {
        String zza2;
        if (this.zzb == null && (zza2 = zzhhh.zza(activity)) != null) {
            zzhhi zzhhi = new zzhhi(this);
            this.zzc = zzhhi;
            CustomTabsClient.bindCustomTabsService(activity, zza2, zzhhi);
        }
    }
    ...
    public final void zze(zzbee zzbee) {
        this.zzd = zzbee;
    }
