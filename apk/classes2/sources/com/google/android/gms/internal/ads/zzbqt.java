...
public final class zzbqt implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    public final void zzd(MediationNativeAdapter mediationNativeAdapter, zzbhk zzbhk) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzo.zze("Adapter called onAdLoaded with template id ".concat(String.valueOf(zzbhk.zzb())));
        this.zzc = zzbhk;
        try {
            this.zza.zzo();
        } catch (RemoteException e) {
    ...
    public final void zze(MediationNativeAdapter mediationNativeAdapter, zzbhk zzbhk, String str) {
        try {
            zzbhk zzbhk2 = zzbhk;
            this.zza.zzr(zzbhk.zza(), str);
        } catch (RemoteException e) {
            zzo.zzl("#007 Could not call remote method.", e);
        }
    }
