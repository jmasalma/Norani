...
final class zzcdi implements Runnable {
    ...
    zzcdi(zzcdn zzcdn, String str, String str2, long j, long j2, long j3, long j4, long j5, boolean z, int i, int i2) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = j;
        this.zzd = j2;
    ...
    public final void run() {
        ...
        if (((Boolean) zzbd.zzc().zzb(zzbde.zzcc)).booleanValue()) {
            ...
            hashMap.put("reportTime", Long.toString(zzv.zzD().currentTimeMillis()));
        }
        if (true != this.zzh) {
            str = "0";
        } else {
