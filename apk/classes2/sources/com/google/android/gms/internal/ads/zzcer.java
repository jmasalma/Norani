...
final class zzcer extends zzgc implements zzhe {
    ...
    zzcer(String str, zzhj zzhj, int i, int i2, long j, long j2) {
        super(true);
        zzdd.zzc(str);
        this.zzd = str;
        this.zzb = i;
    ...
    public final long zzb(zzgo zzgo) throws zzha {
        long j;
        this.zzf = zzgo;
        this.zzm = 0;
        long j2 = zzgo.zze;
        ...
        throw new zzcep(headerField, zzgo);
    }
    ...
    public final HttpURLConnection zzk(long j, long j2, int i) throws zzha {
        ...
        try {
            ...
            try {
                ...
                zzgo zzgo = this.zzf;
                throw new zzha("Unable to connect to ".concat(valueOf), e2, zzgo, 2000, i);
            }
        } catch (IOException e3) {
            IOException iOException = e3;
            String valueOf2 = String.valueOf(uri);
            throw new zzha("Unable to connect to ".concat(valueOf2), iOException, this.zzf, 2000, i);
        }
    }
}
