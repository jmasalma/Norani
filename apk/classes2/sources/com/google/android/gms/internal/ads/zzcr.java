...
public final class zzcr extends zzco {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:35:0x00ea A[LOOP:6: B:35:0x00ea->B:36:0x00ec, LOOP_START, PHI: r0 
      PHI: (r0v2 int) = (r0v0 int), (r0v3 int) binds: [B:14:0x003e, B:36:0x00ec] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final void zze(java.nio.ByteBuffer r12) {
        /*
            ...
            int r1 = r12.limit()
            int r2 = r1 - r0
            com.google.android.gms.internal.ads.zzcl r3 = r11.zzb
            int r3 = r3.zzd
    ...
    public final zzcl zzi(zzcl zzcl) throws zzcm {
        ...
        return new zzcl(zzcl.zzb, zzcl.zzc, 2);
    }
}
