...
public final class zzctl implements zzcza, zzdep {
    ...
    zzctl(Context context, zzfhx zzfhx, VersionInfoParcel versionInfoParcel, Executor executor) {
        this.zzc = context;
        this.zzd = zzfhx;
    ...
    public static /* synthetic */ void zzc(zzctl zzctl) {
        zzbco.zze(zzctl.zzc);
        zzctl.zzh = true;
    }

    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0066, code lost:
        if (android.text.TextUtils.equals(r0, "service") != false) goto L_0x0068;
     */
