...
public final class zzduu extends zzfrz {
    ...
    private long zze = zzv.zzD().currentTimeMillis();
    private int zzf = 0;
    ...
    public final void zza(SensorEvent sensorEvent) {
        if (((Boolean) zzbd.zzc().zzb(zzbde.zzjy)).booleanValue()) {
            ...
            if (this.zze + ((long) ((Integer) zzbd.zzc().zzb(zzbde.zzjA)).intValue()) < currentTimeMillis) {
                this.zzf = 0;
            ...
            float f = this.zzc;
            zzbcv zzbcv = zzbde.zzjz;
            if (floatValue > f + ((Float) zzbd.zzc().zzb(zzbcv)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else if (this.zzd.floatValue() < this.zzc - ((Float) zzbd.zzc().zzb(zzbcv)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzg = true;
            }
            ...
            if (this.zzg && this.zzh) {
                ...
                if (zzdut != null) {
                    if (i == ((Integer) zzbd.zzc().zzb(zzbde.zzjB)).intValue()) {
    ...
    public final void zzc() {
        /*
            r3 = this;
            monitor-enter(r3)
            com.google.android.gms.internal.ads.zzbcv r0 = com.google.android.gms.internal.ads.zzbde.zzjy     // Catch:{ all -> 0x0040 }
            com.google.android.gms.internal.ads.zzbdc r1 = com.google.android.gms.ads.internal.client.zzbd.zzc()     // Catch:{ all -> 0x0040 }
            java.lang.Object r0 = r1.zzb(r0)     // Catch:{ all -> 0x0040 }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ all -> 0x0040 }
            boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x0040 }
            if (r0 != 0) goto L_0x0015
            monitor-exit(r3)     // Catch:{ all -> 0x0040 }
            return
        L_0x0015:
            boolean r0 = r3.zzj     // Catch:{ all -> 0x0040 }
            if (r0 != 0) goto L_0x002d
            android.hardware.SensorManager r0 = r3.zza     // Catch:{ all -> 0x0040 }
            if (r0 == 0) goto L_0x002d
            android.hardware.Sensor r1 = r3.zzb     // Catch:{ all -> 0x0040 }
            if (r1 == 0) goto L_0x002d
            r2 = 2
            r0.registerListener(r3, r1, r2)     // Catch:{ all -> 0x0040 }
            r0 = 1
            r3.zzj = r0     // Catch:{ all -> 0x0040 }
            java.lang.String r0 = "Listening for flick gestures."
            com.google.android.gms.ads.internal.util.zze.zza(r0)     // Catch:{ all -> 0x0040 }
        L_0x002d:
            monitor-exit(r3)     // Catch:{ all -> 0x0040 }
