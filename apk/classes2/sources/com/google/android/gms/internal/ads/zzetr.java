...
public final class zzetr implements zzeub {
    ...
    public final /* bridge */ /* synthetic */ void zzb(Object obj) {
        ...
        bundle.putString("extra_caps", (String) zzbd.zzc().zzb(zzbde.zzdZ));
        bundle.putInt("target_api", this.zze);
        bundle.putInt("dv", this.zzf);
        bundle.putInt("lv", this.zzg);
        if (((Boolean) zzbd.zzc().zzb(zzbde.zzgi)).booleanValue()) {
            String str = this.zzh;
            if (!TextUtils.isEmpty(str)) {
                bundle.putString("ev", str);
            }
        }
        Bundle zza2 = zzfdk.zza(bundle, "sdk_env");
        zza2.putBoolean("mf", ((Boolean) zzbfe.zzc.zze()).booleanValue());
        ...
        Bundle zza3 = zzfdk.zza(zza2, "build_meta");
        zza3.putString("cl", "785558560");
