...
public final class zzfoi {
    ...
    public static zzfoi zza(Context context, Executor executor, boolean z) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        if (z) {
            executor.execute(new zzfog(context, taskCompletionSource));
        } else {
            executor.execute(new zzfoh(taskCompletionSource));
        }
    ...
    private final Task zzh(int i, long j, Exception exc, String str, Map map, String str2) {
        if (!this.zze) {
            return this.zzd.continueWith(this.zzc, new zzfoe());
        }
        ...
        return this.zzd.continueWith(this.zzc, new zzfof(zza2, i));
    }
