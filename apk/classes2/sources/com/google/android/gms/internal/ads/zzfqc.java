...
public final class zzfqc {
    ...
    public zzfqc(Context context, int i, zzfpj zzfpj, boolean z) {
        this.zzb = context;
    ...
    private static String zzf(zzayp zzayp) {
        zzayq zzd2 = zzays.zzd();
        zzd2.zze(zzayp.zzc().zzk());
        zzd2.zza(zzayp.zzc().zzj());
        zzd2.zzb(zzayp.zzc().zza());
        zzd2.zzd(zzayp.zzc().zzc());
        zzd2.zzc(zzayp.zzc().zzb());
        return Hex.bytesToStringLowercase(((zzays) zzd2.zzbr()).zzaV());
    }
    ...
    public final boolean zza(com.google.android.gms.internal.ads.zzayp r7) {
        /*
            r6 = this;
            long r0 = java.lang.System.currentTimeMillis()
            java.lang.Object r2 = zza
            monitor-enter(r2)
            com.google.android.gms.internal.ads.zzays r3 = r7.zzc()     // Catch:{ all -> 0x0054 }
            ...
            com.google.android.gms.internal.ads.zzgxz r3 = r7.zzd()     // Catch:{ all -> 0x0054 }
            byte[] r3 = r3.zzA()     // Catch:{ all -> 0x0054 }
            boolean r3 = com.google.android.gms.internal.ads.zzfpw.zze(r4, r3)     // Catch:{ all -> 0x0054 }
        ...
        L_0x0054:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzfqc.zza(com.google.android.gms.internal.ads.zzayp):boolean");
    }

    public final boolean zzb(zzayp zzayp, zzfqb zzfqb) {
        zzfqb zzfqb2 = zzfqb;
        long currentTimeMillis = System.currentTimeMillis();
        synchronized (zza) {
            zzays zzk = zzk(1);
            String zzk2 = zzayp.zzc().zzk();
            if (zzk == null || !zzk.zzk().equals(zzk2)) {
                ...
                if (!zzfpw.zze(file, zzayp.zzf().zzA())) {
                    zzi(4016, currentTimeMillis);
                    return false;
                } else if (!zzfpw.zze(file2, zzayp.zzd().zzA())) {
                    zzi(4017, currentTimeMillis);
                    return false;
                } else if (zzfqb2 == null || zzfqb2.zza(file)) {
                    String zzf2 = zzf(zzayp);
                    long currentTimeMillis3 = System.currentTimeMillis();
                    SharedPreferences sharedPreferences = this.zzc;
                    String string = sharedPreferences.getString(zzh(), (String) null);
    ...
    public final zzfpu zzc(int i) {
        ...
        synchronized (zza) {
            ...
            zzfpu zzfpu = new zzfpu(zzk, file, file2, file3);
            return zzfpu;
        }
    }
