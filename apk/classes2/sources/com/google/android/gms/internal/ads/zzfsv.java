...
final class zzfsv extends zzfty {
    ...
    /* synthetic */ zzfsv(IBinder iBinder, String str, int i, float f, int i2, int i3, String str2, int i4, String str3, String str4, String str5, zzfsu zzfsu) {
        this.zza = iBinder;
        this.zzb = str;
        this.zzc = i;
        this.zzd = f;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzfty) {
            zzfty zzfty = (zzfty) obj;
            if (this.zza.equals(zzfty.zzf()) && ((str = this.zzb) != null ? str.equals(zzfty.zzh()) : zzfty.zzh() == null) && this.zzc == zzfty.zzc() && Float.floatToIntBits(this.zzd) == Float.floatToIntBits(zzfty.zza())) {
                zzfty.zzb();
                zzfty.zzd();
                zzfty.zzj();
                if (this.zze == zzfty.zze()) {
                    zzfty.zzi();
                    String str2 = this.zzf;
                    if (str2 != null ? str2.equals(zzfty.zzg()) : zzfty.zzg() == null) {
                        zzfty.zzk();
                        return true;
                    }
                }
