                ...
                try {
                    ...
                    if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                        ...
                        for (Signature byteArray : signatureArr) {
                            String zza2 = zzfup.zza(byteArray.toByteArray());
                            arrayList.add(zza2);
                        ...
                        zzfuo.zzd(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", new Object[]{sb.toString()}), new Object[0]);
                    }
