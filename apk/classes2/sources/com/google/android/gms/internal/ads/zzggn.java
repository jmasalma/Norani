...
public final class zzggn {
    ...
    public final zzggn zzf(zzggp zzggp) {
        this.zzf = zzggp;
        return this;
    }
    ...
    public final zzggr zzg() throws GeneralSecurityException {
        if (this.zza == null) {
            ...
            if (num == null) {
                ...
                return new zzggr(this.zza.intValue(), this.zzb.intValue(), this.zzc.intValue(), this.zzd.intValue(), this.zzf, this.zze, (zzggq) null);
            } else {
