...
final class zzhau {
    ...
    static String zza(zzhas zzhas, String str) {
    ...
    private static void zzd(zzhas zzhas, StringBuilder sb, int i) {
        int i2;
        boolean z;
        Method method;
        Method method2;
        ...
        Method[] declaredMethods = zzhas.getClass().getDeclaredMethods();
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List") && (method2 = (Method) entry.getValue()) != null && method2.getReturnType().equals(List.class)) {
                zzb(sb2, i3, substring.substring(0, substring.length() - 4), zzgzh.zzbP(method2, zzhas2, new Object[0]));
            } else if (substring.endsWith("Map") && !substring.equals("Map") && (method = (Method) entry.getValue()) != null && method.getReturnType().equals(Map.class) && !method.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method.getModifiers())) {
                zzb(sb2, i3, substring.substring(0, substring.length() - 3), zzgzh.zzbP(method, zzhas2, new Object[0]));
                ...
                if (method4 != null) {
                    Object zzbP = zzgzh.zzbP(method4, zzhas2, new Object[0]);
                    if (method5 == null) {
                    ...
                    } else if (!((Boolean) zzgzh.zzbP(method5, zzhas2, new Object[0])).booleanValue()) {
                    }
        ...
        if (zzhas2 instanceof zzgzd) {
            Iterator zzf = ((zzgzd) zzhas2).zza.zzf();
            while (zzf.hasNext()) {
                Map.Entry entry2 = (Map.Entry) zzf.next();
                zzb(sb2, i3, "[" + ((zzgze) entry2.getKey()).zza + "]", entry2.getValue());
            }
        }
        zzhby zzhby = ((zzgzh) zzhas2).zzt;
        if (zzhby != null) {
            zzhby.zzi(sb2, i3);
        }
    }
