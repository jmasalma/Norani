...
interface zzhbf {
    ...
    @Deprecated
    void zzC(List list, zzhbl zzhbl, zzgyr zzgyr) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhbl zzhbl, zzgyr zzgyr) throws IOException;
    ...
    void zzt(Object obj, zzhbl zzhbl, zzgyr zzgyr) throws IOException;

    void zzu(Object obj, zzhbl zzhbl, zzgyr zzgyr) throws IOException;
