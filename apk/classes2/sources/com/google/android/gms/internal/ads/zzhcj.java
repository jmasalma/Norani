...
final class zzhcj {
    private static final zzhcg zza = new zzhch();
    ...
    static int zzd(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        L_0x00bd:
            r1 = r4
        L_0x00be:
            com.google.android.gms.internal.ads.zzhci r8 = new com.google.android.gms.internal.ads.zzhci
            int r1 = r1 + -1
            r8.<init>(r1, r0)
            throw r8
        L_0x00c6:
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzgzw {
        ...
        if (byteBuffer.hasArray()) {
            return zzhcg.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
