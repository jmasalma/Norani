...
public final class zzhgk {
    ...
    public final boolean equals(Object obj) {
        ...
        zzhgk zzhgk = (zzhgk) obj;
        return Double.compare(zzhgk.zzh, this.zzh) == 0 && Double.compare(zzhgk.zzi, this.zzi) == 0 && Double.compare(zzhgk.zzj, this.zzj) == 0 && Double.compare(zzhgk.zzk, this.zzk) == 0 && Double.compare(zzhgk.zzl, this.zzl) == 0 && Double.compare(zzhgk.zzm, this.zzm) == 0 && Double.compare(zzhgk.zze, this.zze) == 0 && Double.compare(zzhgk.zzf, this.zzf) == 0 && Double.compare(zzhgk.zzg, this.zzg) == 0;
    }
