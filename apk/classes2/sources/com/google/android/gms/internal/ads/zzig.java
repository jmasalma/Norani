...
public final class zzig {
    ...
    /* synthetic */ zzig(float f, float f2, long j, float f3, long j2, long j3, float f4, zzif zzif) {
        this.zza = j2;
        this.zzb = j3;
    }
    ...
    public final void zzd(zzaj zzaj) {
        long j = zzaj.zza;
    ...
    public final float zza(long j, long j2) {
        ...
        if (this.zzh > j6) {
            ...
            long j8 = this.zzh;
            String str = zzex.zza;
            long max2 = Math.max(j8, Math.min(j - ((long) (Math.max(0.0f, this.zzk - 4.0f) / 1.0E-7f)), j6));
            this.zzh = max2;
            long j9 = this.zzg;
