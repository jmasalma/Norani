...
public final class zzam {
    ...
    public final boolean zzd() {
        ...
        try {
            ...
            this.zzb.set(cls.getDeclaredMethod("getInstance", new Class[]{Context.class}).invoke((Object) null, new Object[]{context}));
            this.zzc.set(cls.getDeclaredMethod("setConsent", new Class[]{Map.class}));
            ...
            Method declaredMethod = cls2.getDeclaredMethod("valueOf", new Class[]{String.class});
            Method declaredMethod2 = cls3.getDeclaredMethod("valueOf", new Class[]{String.class});
