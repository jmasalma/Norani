...
public abstract class zzjb implements Iterable, Serializable {
    ...
    public final String toString() {
        return String.format(Locale.ROOT, "<ByteString@%s size=%d contents=\"%s\">", new Object[]{Integer.toHexString(System.identityHashCode(this)), Integer.valueOf(zzd()), zzd() <= 50 ? zzmj.zza(this) : zzmj.zza(zzf(0, 47)).concat("...")});
    }
