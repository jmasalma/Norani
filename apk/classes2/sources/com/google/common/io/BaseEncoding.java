...
public abstract class BaseEncoding {
        ...
        public OutputStream encodingStream(final Writer writer) {
            ...
            return new OutputStream() {
                ...
                public void write(int i) throws IOException {
                    this.bitBuffer = (i & KotlinVersion.MAX_COMPONENT_VALUE) | (this.bitBuffer << 8);
                            ...
                            if (StandardBaseEncoding.this.paddingChar == null || StandardBaseEncoding.this.paddingChar.charValue() != c) {
                                if (!this.hitPadding) {
                                    ...
                                    if (i2 >= 8) {
                                        ...
                                        return (this.bitBuffer >> i3) & KotlinVersion.MAX_COMPONENT_VALUE;
                                    }
                                } else {
    ...
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        private Base16Encoding(Alphabet alphabet) {
            ...
            this.encoding = new char[ConstantsKt.MINIMUM_BLOCK_SIZE];
            ...
            if (this.alphabet.isValidPaddingStartPosition(trimTrailingPadding.length())) {
                ...
                while (i < trimTrailingPadding.length()) {
                    ...
                    if (i3 < trimTrailingPadding.length()) {
                        ...
                        int i6 = i2 + 2;
                        bArr[i4] = (byte) ((decode2 >>> 8) & KotlinVersion.MAX_COMPONENT_VALUE);
                        if (i5 < trimTrailingPadding.length()) {
                            i += 4;
                            i2 += 3;
                            bArr[i6] = (byte) ((decode2 | this.alphabet.decode(trimTrailingPadding.charAt(i5))) & KotlinVersion.MAX_COMPONENT_VALUE);
                        } else {
                            i2 = i6;
                            i = i5;
                        }
