...
public final class IntMath {
    ...
    static int[] biggestBinomials = {IntCompanionObject.MAX_VALUE, IntCompanionObject.MAX_VALUE, 65536, 2345, 477, 193, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    static final int[] powersOf10 = {1, 10, 100, zzbcj.zzq.zzf, 10000, 100000, DurationKt.NANOS_IN_MILLIS, 10000000, 100000000, 1000000000};
    ...
    public static int saturatedPow(int i, int i2) {
        ...
        if (i != -2) {
            ...
            return (i2 & 1) + IntCompanionObject.MAX_VALUE;
        } else {
            return (i2 & 1) == 0 ? 1 << i2 : -1 << i2;
        }
    }
