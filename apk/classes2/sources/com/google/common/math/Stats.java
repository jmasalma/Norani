...
public final class Stats implements Serializable {
    ...
    public void writeTo(ByteBuffer byteBuffer) {
        ...
        Preconditions.checkArgument(byteBuffer.remaining() >= BYTES, "Expected at least Stats.BYTES = %s remaining , got %s", (int) BYTES, byteBuffer.remaining());
        byteBuffer.putLong(this.count).putDouble(this.mean).putDouble(this.sumOfSquaresOfDeltas).putDouble(this.min).putDouble(this.max);
    }

    public static Stats fromByteArray(byte[] bArr) {
        Preconditions.checkNotNull(bArr);
        Preconditions.checkArgument(bArr.length == BYTES, "Expected Stats.BYTES = %s remaining , got %s", (int) BYTES, bArr.length);
