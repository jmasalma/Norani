        ...
        if (listenableFuture instanceof Trusted) {
            ...
            if (obj instanceof Cancellation) {
                ...
                if (cancellation.wasInterrupted) {
                    obj = cancellation.cause != null ? new Cancellation(GENERATE_CANCELLATION_CAUSES, cancellation.cause) : Cancellation.CAUSELESS_CANCELLED;
                }
            }
            ...
            try {
                ...
                if (isCancelled) {
                    ...
                    return new Cancellation(GENERATE_CANCELLATION_CAUSES, new IllegalArgumentException(new StringBuilder(String.valueOf(valueOf).length() + 84).append("get() did not throw CancellationException, despite reporting isCancelled() == true: ").append(valueOf).toString()));
                ...
                return new Cancellation(GENERATE_CANCELLATION_CAUSES, new IllegalArgumentException(new StringBuilder(String.valueOf(valueOf2).length() + 84).append("get() did not throw CancellationException, despite reporting isCancelled() == true: ").append(valueOf2).toString(), e));
            } catch (CancellationException e2) {
                if (isCancelled) {
                    return new Cancellation(GENERATE_CANCELLATION_CAUSES, e2);
                }
        ...
        public boolean casWaiters(AbstractFuture<?> abstractFuture, @CheckForNull Waiter waiter, @CheckForNull Waiter waiter2) {
            synchronized (abstractFuture) {
                if (abstractFuture.waiters != waiter) {
                    return AbstractFuture.GENERATE_CANCELLATION_CAUSES;
                }
