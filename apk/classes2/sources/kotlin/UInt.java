...
public final class UInt implements Comparable<UInt> {
    ...
    public static boolean m115equalsimpl(int i, Object obj) {
        return (obj instanceof UInt) && i == ((UInt) obj).m161unboximpl();
    }
    ...
    private static final int m157toUIntpVg5ArA(int i) {
        return i;
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(Object obj) {
        return UnsignedKt.uintCompare(m161unboximpl(), ((UInt) obj).m161unboximpl());
    }
    ...
    private static final int m104compareTo7apg3OU(int i, byte b) {
        return Integer.compareUnsigned(i, m109constructorimpl(b & 255));
    }

    /* renamed from: compareTo-xj2QHRw  reason: not valid java name */
    private static final int m108compareToxj2QHRw(int i, short s) {
        return Integer.compareUnsigned(i, m109constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: compareTo-WZ4Q5Ns  reason: not valid java name */
    private int m106compareToWZ4Q5Ns(int i) {
        return UnsignedKt.uintCompare(m161unboximpl(), i);
    }
    ...
    private static final int m105compareToVKZWuLQ(int i, long j) {
        return Long.compareUnsigned(ULong.m188constructorimpl(((long) i) & 4294967295L), j);
    }

    /* renamed from: plus-7apg3OU  reason: not valid java name */
    private static final int m133plus7apg3OU(int i, byte b) {
        return m109constructorimpl(i + m109constructorimpl(b & 255));
    }
    ...
    private static final long m134plusVKZWuLQ(int i, long j) {
        return ULong.m188constructorimpl(ULong.m188constructorimpl(((long) i) & 4294967295L) + j);
    }
    ...
    private static final int m111div7apg3OU(int i, byte b) {
        return Integer.divideUnsigned(i, m109constructorimpl(b & 255));
    }

    /* renamed from: div-xj2QHRw  reason: not valid java name */
    private static final int m114divxj2QHRw(int i, short s) {
        return Integer.divideUnsigned(i, m109constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: div-WZ4Q5Ns  reason: not valid java name */
    private static final int m113divWZ4Q5Ns(int i, int i2) {
        return UnsignedKt.m365uintDivideJ1ME1BU(i, i2);
    }

    /* renamed from: div-VKZWuLQ  reason: not valid java name */
    private static final long m112divVKZWuLQ(int i, long j) {
        return Long.divideUnsigned(ULong.m188constructorimpl(((long) i) & 4294967295L), j);
    }

    /* renamed from: rem-7apg3OU  reason: not valid java name */
    private static final int m139rem7apg3OU(int i, byte b) {
        return Integer.remainderUnsigned(i, m109constructorimpl(b & 255));
    }

    /* renamed from: rem-xj2QHRw  reason: not valid java name */
    private static final int m142remxj2QHRw(int i, short s) {
        return Integer.remainderUnsigned(i, m109constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: rem-WZ4Q5Ns  reason: not valid java name */
    private static final int m141remWZ4Q5Ns(int i, int i2) {
        return UnsignedKt.m366uintRemainderJ1ME1BU(i, i2);
    }

    /* renamed from: rem-VKZWuLQ  reason: not valid java name */
    private static final long m140remVKZWuLQ(int i, long j) {
        return Long.remainderUnsigned(ULong.m188constructorimpl(((long) i) & 4294967295L), j);
    }
    ...
    private static final byte m128mod7apg3OU(int i, byte b) {
        return UByte.m32constructorimpl((byte) Integer.remainderUnsigned(i, m109constructorimpl(b & 255)));
    }

    /* renamed from: mod-xj2QHRw  reason: not valid java name */
    private static final short m131modxj2QHRw(int i, short s) {
        return UShort.m295constructorimpl((short) Integer.remainderUnsigned(i, m109constructorimpl(s & UShort.MAX_VALUE)));
    }
    ...
    private static final UIntRange m138rangeUntilWZ4Q5Ns(int i, int i2) {
        return URangesKt.m1289untilJ1ME1BU(i, i2);
    }

    /* renamed from: shl-pVg5ArA  reason: not valid java name */
    private static final int m143shlpVg5ArA(int i, int i2) {
        return m109constructorimpl(i << i2);
    }

    /* renamed from: shr-pVg5ArA  reason: not valid java name */
    private static final int m144shrpVg5ArA(int i, int i2) {
        return m109constructorimpl(i >>> i2);
    }
    ...
    private static final byte m156toUBytew2LRezQ(int i) {
        return UByte.m32constructorimpl((byte) i);
    }

    /* renamed from: toUShort-Mh2AYeg  reason: not valid java name */
    private static final short m159toUShortMh2AYeg(int i) {
        return UShort.m295constructorimpl((short) i);
    }

    /* renamed from: toULong-s-VKNKU  reason: not valid java name */
    private static final long m158toULongsVKNKU(int i) {
        return ULong.m188constructorimpl(((long) i) & 4294967295L);
    }
