...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static int[] m164constructorimpl(int[] iArr) {
    ...
    public static final int m169getpVg5ArA(int[] iArr, int i) {
    ...
    public static java.util.Iterator<UInt> m173iteratorimpl(int[] iArr) {
    ...
    private static final class Iterator implements java.util.Iterator<UInt>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ Object next() {
            return UInt.m103boximpl(m179nextpVg5ArA());
        }
    ...
    public static boolean m166containsAllimpl(int[] r3, java.util.Collection<kotlin.UInt> r4) {
        /*
        ...
        L_0x0032:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.UIntArray.m166containsAllimpl(int[], java.util.Collection):boolean");
    }
