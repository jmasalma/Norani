...
class UComparisonsKt___UComparisonsKt {
    ...
    public static final int m1205maxOfMd2H83M(int i, int... iArr) {
        ...
        int r0 = UIntArray.m170getSizeimpl(iArr);
        for (int i2 = 0; i2 < r0; i2++) {
            i = UComparisonsKt.m1203maxOfJ1ME1BU(i, UIntArray.m169getpVg5ArA(iArr, i2));
        }
        return i;
    }
    ...
    public static final long m1206maxOfR03FKyM(long j, long... jArr) {
        ...
        int r0 = ULongArray.m249getSizeimpl(jArr);
        for (int i = 0; i < r0; i++) {
            j = UComparisonsKt.m1211maxOfeb3DHEI(j, ULongArray.m248getsVKNKU(jArr, i));
        }
        return j;
    }
    ...
    public static final byte m1209maxOfWr6uiD8(byte b, byte... bArr) {
        ...
        int r0 = UByteArray.m91getSizeimpl(bArr);
        for (int i = 0; i < r0; i++) {
            b = UComparisonsKt.m1204maxOfKr8caGY(b, UByteArray.m90getw2LRezQ(bArr, i));
        }
        return b;
    }
    ...
    public static final short m1213maxOft1qELG4(short s, short... sArr) {
        ...
        int r0 = UShortArray.m354getSizeimpl(sArr);
        for (int i = 0; i < r0; i++) {
            s = UComparisonsKt.m1202maxOf5PvTz6A(s, UShortArray.m353getMh2AYeg(sArr, i));
        }
        return s;
    }
    ...
    public static final int m1217minOfMd2H83M(int i, int... iArr) {
        ...
        int r0 = UIntArray.m170getSizeimpl(iArr);
        for (int i2 = 0; i2 < r0; i2++) {
            i = UComparisonsKt.m1215minOfJ1ME1BU(i, UIntArray.m169getpVg5ArA(iArr, i2));
        }
        return i;
    }
    ...
    public static final long m1218minOfR03FKyM(long j, long... jArr) {
        ...
        int r0 = ULongArray.m249getSizeimpl(jArr);
        for (int i = 0; i < r0; i++) {
            j = UComparisonsKt.m1223minOfeb3DHEI(j, ULongArray.m248getsVKNKU(jArr, i));
        }
        return j;
    }
    ...
    public static final byte m1221minOfWr6uiD8(byte b, byte... bArr) {
        ...
        int r0 = UByteArray.m91getSizeimpl(bArr);
        for (int i = 0; i < r0; i++) {
            b = UComparisonsKt.m1216minOfKr8caGY(b, UByteArray.m90getw2LRezQ(bArr, i));
        }
        return b;
    }
    ...
    public static final short m1225minOft1qELG4(short s, short... sArr) {
        ...
        int r0 = UShortArray.m354getSizeimpl(sArr);
        for (int i = 0; i < r0; i++) {
            s = UComparisonsKt.m1214minOf5PvTz6A(s, UShortArray.m353getMh2AYeg(sArr, i));
        }
        return s;
    }
}
