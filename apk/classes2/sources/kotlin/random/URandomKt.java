...
public final class URandomKt {
    ...
    public static final int m1240nextUInta8DCA5k(Random random, int i, int i2) {
        ...
        return UInt.m109constructorimpl(random.nextInt(i ^ IntCompanionObject.MIN_VALUE, i2 ^ IntCompanionObject.MIN_VALUE) ^ IntCompanionObject.MIN_VALUE);
    }
    ...
    public static final int nextUInt(Random random, UIntRange uIntRange) {
        ...
        } else if (Integer.compareUnsigned(uIntRange.m1245getLastpVg5ArA(), -1) < 0) {
            return m1240nextUInta8DCA5k(random, uIntRange.m1244getFirstpVg5ArA(), UInt.m109constructorimpl(uIntRange.m1245getLastpVg5ArA() + 1));
        } else {
            if (Integer.compareUnsigned(uIntRange.m1244getFirstpVg5ArA(), 0) > 0) {
                return UInt.m109constructorimpl(m1240nextUInta8DCA5k(random, UInt.m109constructorimpl(uIntRange.m1244getFirstpVg5ArA() - 1), uIntRange.m1245getLastpVg5ArA()) + 1);
            }
    ...
    public static final long m1243nextULongjmpaWc(Random random, long j, long j2) {
        ...
        return ULong.m188constructorimpl(random.nextLong(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) ^ Long.MIN_VALUE);
    }
    ...
    public static final long nextULong(Random random, ULongRange uLongRange) {
        ...
        } else if (Long.compareUnsigned(uLongRange.m1254getLastsVKNKU(), -1) < 0) {
            return m1243nextULongjmpaWc(random, uLongRange.m1253getFirstsVKNKU(), ULong.m188constructorimpl(uLongRange.m1254getLastsVKNKU() + ULong.m188constructorimpl(((long) 1) & 4294967295L)));
        } else {
            if (Long.compareUnsigned(uLongRange.m1253getFirstsVKNKU(), 0) <= 0) {
                return nextULong(random);
            }
            long j = ((long) 1) & 4294967295L;
            return ULong.m188constructorimpl(m1243nextULongjmpaWc(random, ULong.m188constructorimpl(uLongRange.m1253getFirstsVKNKU() - ULong.m188constructorimpl(j)), uLongRange.m1254getLastsVKNKU()) + ULong.m188constructorimpl(j));
        }
    }
    ...
    public static final void m1236checkULongRangeBoundseb3DHEI(long j, long j2) {
        if (Long.compareUnsigned(j2, j) <= 0) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m182boximpl(j), ULong.m182boximpl(j2)).toString());
        }
    }
}
