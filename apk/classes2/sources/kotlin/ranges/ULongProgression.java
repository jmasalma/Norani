...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m188constructorimpl(j ^ ULong.m188constructorimpl(j >>> 32))) * 31) + ((int) ULong.m188constructorimpl(j2 ^ ULong.m188constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(ULong.m234toStringimpl(this.first)).append("..").append(ULong.m234toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder().append(ULong.m234toStringimpl(this.first)).append(" downTo ").append(ULong.m234toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1255fromClosedRange7ftBX0g(long j, long j2, long j3) {
