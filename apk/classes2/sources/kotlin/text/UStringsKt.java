...
public final class UStringsKt {
    ...
    public static final String m1318toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1320toStringolVBNx4(short s, int i) {
    ...
    public static final String m1319toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1317toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m82unboximpl();
        }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m240unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(r1, UInt.m109constructorimpl(KotlinVersion.MAX_COMPONENT_VALUE)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m161unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m109constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m289boximpl(UShort.m295constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m109constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m109constructorimpl(i3 * r3);
            int r7 = UInt.m109constructorimpl(UInt.m109constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m188constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m188constructorimpl(j * r5);
            long r13 = ULong.m188constructorimpl(ULong.m188constructorimpl(((long) UInt.m109constructorimpl(digitOf)) & 4294967295L) + r9);
