...
public final class LongSaturatedMathKt {
    ...
    public static final long m1474saturatingAddpTJri5U(long j, long j2) {
        long r4 = Duration.m1366getInWholeNanosecondsimpl(j2);
        if (((j - 1) | 1) == LongCompanionObject.MAX_VALUE) {
            return m1473checkInfiniteSumDefinedPjuGub4(j, j2, r4);
        }
        if ((1 | (r4 - 1)) == LongCompanionObject.MAX_VALUE) {
            return m1475saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + r4;
        if (((j ^ j3) & (r4 ^ j3)) >= 0) {
            return j3;
    ...
    private static final long m1473checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m1378isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m1475saturatingAddInHalvespTJri5U(long j, long j2) {
        long r0 = Duration.m1349divUwyO8pc(j2, 2);
        if (((Duration.m1366getInWholeNanosecondsimpl(r0) - 1) | 1) == LongCompanionObject.MAX_VALUE) {
            return (long) (((double) j) + Duration.m1389toDoubleimpl(j2, DurationUnit.NANOSECONDS));
        }
        return m1474saturatingAddpTJri5U(m1474saturatingAddpTJri5U(j, r0), Duration.m1381minusLRDsOJo(j2, r0));
    }

    public static final long saturatingDiff(long j, long j2) {
        if ((1 | (j2 - 1)) == LongCompanionObject.MAX_VALUE) {
            return Duration.m1398unaryMinusUwyO8pc(DurationKt.toDuration(j2, DurationUnit.DAYS));
        }
    ...
    public static final long saturatingOriginsDiff(long j, long j2) {
        if (((j2 - 1) | 1) == LongCompanionObject.MAX_VALUE) {
            ...
            return Duration.m1398unaryMinusUwyO8pc(DurationKt.toDuration(j2, DurationUnit.DAYS));
        } else if ((1 | (j - 1)) == LongCompanionObject.MAX_VALUE) {
    ...
    private static final long saturatingFiniteDiff(long j, long j2) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            ...
            return Duration.m1382plusLRDsOJo(duration, DurationKt.toDuration(j5, DurationUnit.NANOSECONDS));
        }
