...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1481plusAssignLRDsOJo(long j) {
        long j2;
        long r0 = Duration.m1392toLongimpl(j, getUnit());
        if (r0 == Long.MIN_VALUE || r0 == LongCompanionObject.MAX_VALUE) {
            double r2 = ((double) this.reading) + Duration.m1389toDoubleimpl(j, getUnit());
    ...
    private final void m1480overflowLRDsOJo(long j) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + DurationUnitKt.shortName(getUnit()) + " is advanced by " + Duration.m1395toStringimpl(j) + '.');
    }
}
