...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    private final boolean cancelLater(Throwable th) {
        ...
        DispatchedContinuation dispatchedContinuation = this.delegate;
        Intrinsics.checkNotNull(dispatchedContinuation, "null cannot be cast to non-null type kotlinx.coroutines.internal.DispatchedContinuation<*>");
        return dispatchedContinuation.postponeCancellation$kotlinx_coroutines_core(th);
    }
        ...
        if (state$kotlinx_coroutines_core instanceof CompletedExceptionally) {
            ...
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (continuation2 instanceof CoroutineStackFrame) {
                    cancellationException = StackTraceRecoveryKt.access$recoverFromStackFrame(cancellationException, (CoroutineStackFrame) continuation2);
                }
            }
    ...
    public final void releaseClaimedReusableContinuation$kotlinx_coroutines_core() {
        ...
        if (dispatchedContinuation2 != null && (tryReleaseClaimedContinuation$kotlinx_coroutines_core = dispatchedContinuation2.tryReleaseClaimedContinuation$kotlinx_coroutines_core(this)) != null) {
            detachChild$kotlinx_coroutines_core();
