...
public final class DelayKt {
    ...
    public static final Object m1518delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1519toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1519toDelayMillisLRDsOJo(long j) {
        if (Duration.m1345compareToLRDsOJo(j, Duration.Companion.m1448getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1364getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
