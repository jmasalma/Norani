...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    private final void notifyCancelling(NodeList nodeList, Throwable th) {
        ...
        for (JobNode jobNode = (LockFreeLinkedListNode) next; !Intrinsics.areEqual((Object) jobNode, (Object) lockFreeLinkedListHead); jobNode = jobNode.getNextNode()) {
    ...
    public final SelectClause1<?> getOnAwaitInternal() {
        ...
        return (SelectClause1) new SelectClause1Impl<>(this, (Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(jobSupport$onAwaitInternal$1, 3), (Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(jobSupport$onAwaitInternal$2, 3), (Function3) null, 8, (DefaultConstructorMarker) null);
    }
